...
depression_prs=c(AP,quantile(r,c(0.025,0.975)))
print("finished depression")
...
sleepiness_prs=c(AP,quantile(r,c(0.025,0.975)))
print("finished sleepiness")




prs_summary = data.frame(rbind(depression_prs,sleepiness_prs))
write_csv(prs_summary,"prs_APs_2.csv")
