...
epilepsy_prs=c(AP,quantile(r,c(0.025,0.975)))
print("finished epilepsy")
...
dm_prs=c(AP,quantile(r,c(0.025,0.975)))
print("finished dm")



prs_summary = data.frame(rbind(epilepsy_prs,dm_prs))
write_csv(prs_summary,"prs_APs_3.csv")
